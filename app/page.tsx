...
export default function HomePage() {
  ...
  return (
    <PageContainer withPadding={false} className="relative">
      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-[70vh] sm:min-h-[80vh] lg:min-h-screen flex items-center justify-center overflow-hidden pt-16 sm:pt-20">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="hidden md:block absolute top-20 left-10 animate-float opacity-30">
            <Sprout className="h-24 w-24 text-primary" />
          </div>
          <div className="hidden md:block absolute top-40 right-20 animate-float-slow opacity-25" style={{ animationDelay: "1s" }}>
            <Leaf className="h-32 w-32 text-secondary" />
          </div>
          <div className="hidden md:block absolute bottom-40 left-1/4 animate-float opacity-20" style={{ animationDelay: "2s" }}>
            <Droplets className="h-20 w-20 text-accent" />
          </div>
          <div className="hidden md:block absolute bottom-20 right-1/3 animate-float-slow opacity-25" style={{ animationDelay: "3s" }}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold text-foreground leading-tight animate-fade-in-up text-balance drop-shadow-lg">
              Cultivons l'avenir de <span className="text-primary animate-pulse-glow">l'agriculture</span> ensemble
            </h1>

            <p className="text-lg sm:text-xl text-foreground/90 max-w-prose mx-auto leading-relaxed animate-fade-in-up text-pretty drop-shadow-md">
      ...
      <section className="py-14 sm:py-20 relative">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16 fade-in-element">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-foreground mb-4">Nos Domaines d'Expertise</h2>
      ...
      {/* Stats Section */}
      <section className="py-14 sm:py-20 bg-linear-to-br from-primary via-secondary to-accent text-primary-foreground relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center">
            {[
              ...
              <div
                ...
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div className="text-5xl sm:text-6xl md:text-7xl font-bold mb-2 animate-pulse-glow">{stat.value}</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="relative overflow-hidden border-2 border-primary/30 bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10 shadow-2xl">
            <CardContent className="p-8 sm:p-12 text-center space-y-6 relative z-10">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-prose mx-auto leading-relaxed">
